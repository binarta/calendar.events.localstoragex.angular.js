# calendar.events.angular.js

[AngularJS](http://angularjs.org/) module for calendar events persisted in local storage based on the [Binarta](http://binarta.com/) platform.
